...
export default function Navbar() {
  ...
  const avatarSrc = user?.image || "/default-avatar.png"; // Put a default avatar in public folder
            ...
            {!isLoggedIn ? (
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-full border-2 border-white shadow-md hover:ring-2 hover:ring-[#005cc8]/30 transition-all">
                    <Image
                      src={avatarSrc}
                      alt={user?.name || "User"}
                      width={44}
